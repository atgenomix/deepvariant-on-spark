...
if [[ ${ref_version} == "38" ]]; then
  ...
  -l 153=chr9:127950000-138394717 -l 154=chr5:40000000-50080000 -l 155=chrM:0-16569"
    )
  ...
  -l 153=chr2:234030000-243199373 -l 154=chr9:133100000-141213431 -l 155=chrM:0-16569"
    )
else
