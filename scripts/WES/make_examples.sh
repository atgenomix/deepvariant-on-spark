...
usage() {
  echo "Usage:"
  echo $'\t' "$0 <Selected BAM folder> <BED folder> <Reference Version> <Contig Type> <Exom Kit> <Output Folder> "
  echo "Parameters:"
...
#       31      |        2       |     1g(7g)      |     32     |   250G    |    63   | 01:57:22 |
...
${spark} \
  ...
  bam2vcf \
      ...
      --java-mem-in-mb 5120 \
      --target-interval hdfs:///target_interval/${ref_version}/${target_interval}
