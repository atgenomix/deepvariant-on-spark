...
if [[ ${ref_version} == "38" ]]; then
    partition_array=(
    "-l 000=chr1:0-248956422 -l 001=chr10:0-133797422 -l 002=chr12:0-133275309 \
  -l 003=chr15:0-101991189"
    
    "-l 004=chr2:0-242193529 -l 005=chr14:0-107043718 -l 006=chr20:0-64444167 \
  -l 007=chr22:0-50818468 -l 008=chrX:0-156040895"

     "-l 009=chr3:0-198295559 -l 010=chr5:0-181538259 -l 011=chr8:0-145138636 \
  -l 012=chr16:0-90338345"

     "-l 013=chr4:0-190214555 -l 014=chr7:0-159345973 -l 015=chr17:0-83257441 \
  -l 016=chr18:0-80373285 -l 017=chr21:0-46709983 -l 018=chrY:0-57227415"

     "-l 019=chr6:0-170805979 -l 020=chr9:0-138394717 -l 021=chr11:0-135086622 \
  -l 022=chr13:0-114364328 -l 023=chr19:0-58617616"
    )

elif [[ ${ref_version} == "19" ]]; then
    partition_array=(
    "-l 000=chr1:0-249250621 -l 001=chr3:0-198022430 -l 002=chr16:0-90354753 \
  -l 003=chr17:0-81195210" 

     "-l 004=chr2:0-243199373 -l 005=chr7:0-159138663 -l 006=chr14:0-107349540 \
  -l 007=chr19:0-59128983 -l 008=chr22:0-51304566"

     "-l 009=chr8:0-146364022 -l 010=chr10:0-135534747 -l 011=chr12:0-133851895 \
  -l 012=chr21:0-48129895 -l 013=chrX:0-155270560"

     "-l 014=chr4:0-191154276 -l 015=chr6:0-171115067 -l 016=chr11:0-135006516 \
  -l 017=chr20:0-63025520 -l 018=chrY:0-59373566"

     "-l 019=chr5:0-180915260 -l 020=chr9:0-141213431 -l 021=chr13:0-115169878 \
  -l 022=chr15:0-102531392 -l 023=chr18:0-78077248"
    )
fi
